...
export default function ScalarMap2D({
  ...
  return (
    <div className="relative h-full min-h-[360px] overflow-hidden bg-[#071016]">
      <canvas
        ...
        role="img"
      />
      <div className="pointer-events-none absolute right-4 top-4 rounded-md border border-slate-700 bg-slate-950/85 px-3 py-2 text-[10px] text-slate-400 backdrop-blur">
        <div className="mb-1 font-semibold uppercase tracking-wider text-slate-300">{field}</div>
        <div className="h-1.5 w-28 rounded-full bg-gradient-to-r from-[#440154] via-[#21918c] to-[#fde725]" />
